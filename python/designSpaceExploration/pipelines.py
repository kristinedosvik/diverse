...
b1_hw_spec = ["spectral_binning", "x", "x", "x", "x", "x", "x", "x", "x", "CCSDS123_B2_hw"]
b1_sw_spec = ["spectral_binning", "x", "x", "x", "x", "x", "x", "x", "x", "CCSDS123_B2_sw"]
...
svm_ica_spec_dete_snk_radio = ["spectral_binning", "x", "x", "radiometric_calibration", "mean_threshold_detection", "nearest_neighbour_correction", "smile_and_keystone", "ICA", "x", "SVM"]

classification_pipelines = [svm, svm_spectral, svm_pca_hw_spec, svm_pca_hw_spec_dete_snk_radio, svm_ica_spec_dete_snk_radio]
...
ace_hw = ["x", "x", "x", "x", "x", "x", "x", "x", "x", "ACE_hw"]
ace_hw_spectral = ["spectral_binning", "x", "x", "x", "x", "x", "x", "x", "x", "ACE_hw"]
...
sam_sw_spec_dete_snk_radio_pca_hw = ["spectral_binning", "x", "x", "radiometric_calibration", "mean_threshold_detection", "nearest_neighbour_correction", "smile_and_keystone", "x", "PCA_hw", "SAM_sw"]

sam_sw_spec_dete_snk_radio_pca_hw = ["spectral_binning", "x", "x", "radiometric_calibration", "mean_threshold_detection", "nearest_neighbour_correction", "smile_and_keystone", "x", "PCA_sw", "SAM_sw"]
