...
def OC_F_MGD(frames, framesamples, bands, outer_window, inner_window):
...
def OC_FrFT_RX(frames, framesamples, bands, outer_window, inner_window):
    return OC_LRX(frames, framesamples, bands, outer_window, inner_window)

def OC_CRD(frames, framesamples, bands, outer_window, inner_window):
    return OC_LRX(frames, framesamples, bands, outer_window, inner_window)
